    ...
    <footer class="wow fadeInUp relative z-10 bg-black  " data-wow-delay=".15s" style="background-color: #4d5d36;">    
            ...
            <div class="w-full px-4 md:w-2/3 lg:w-1/2">
              <div class="my-1">
                ...
                >
                  <a
                    href="javascript:void(0)"
                    class="px-3 text-base text-[#f3f4fe] hover:text-f3f4fe"
                    style="a:hover {
                      color: #4d5d36;
                    }"
                  >
            ...
            <div class="w-full px-4 md:w-1/3 lg:w-1/2">
              <div class="my-1 flex justify-center md:justify-end">
                <p class="text-base text-[#f3f4fe]">
                  © 2023 Masjid Raheela by Pesan Trend
                  <a
                    href="https://tailgrids.com"
                    rel="nofollow noopner"
                    target="_blank"
