...
<html lang="en" class="scroll-smooth">
  ...
  <body>
    ...
    <section class="pt-20 pb-8 lg:pt-[120px] lg:pb-[70px]" id="about">
      <div class="container">
            ...
            <div class="w-full px-4">
              ...
              >
                ...
                >
                  ...
                  >
                    Looking to take your career or business to the next level? 
                  </h2>
                  <p class="mb-9 text-base leading-relaxed text-body-color">
                    Attending a high-quality seminar or conference can provide you with the knowledge, 
                    skills, and networking opportunities needed to succeed in today's fast-paced 
                    business world.
                  </p>
                  <p class="mb-9 text-base leading-relaxed text-body-color">
                    Don't miss out on this opportunity to grow and succeed. Register for our
                    upcoming seminar/conference today and take the first step towards achieving
                    your goals!
                  </p>
                  <a
                    href="javascript:void(0)"
