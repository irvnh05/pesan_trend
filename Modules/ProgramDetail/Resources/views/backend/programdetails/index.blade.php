                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("programdetail::text.name")
                            </th>
                            <th>
                                @lang("programdetail::text.slug")
                            </th>
                            <th>
                                @lang("programdetail::text.updated_at")
                            </th>
                            <th>
                                @lang("programdetail::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("programdetail::text.action")
                            </th>
                        </tr>
                    </thead>
