                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("programcategory::text.name")
                            </th>
                            <th>
                                @lang("programcategory::text.slug")
                            </th>
                            <th>
                                @lang("programcategory::text.updated_at")
                            </th>
                            <th>
                                @lang("programcategory::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("programcategory::text.action")
                            </th>
                        </tr>
                    </thead>
