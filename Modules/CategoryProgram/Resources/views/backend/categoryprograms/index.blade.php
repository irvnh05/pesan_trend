                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("categoryprogram::text.name")
                            </th>
                            <th>
                                @lang("categoryprogram::text.slug")
                            </th>
                            <th>
                                @lang("categoryprogram::text.updated_at")
                            </th>
                            <th>
                                @lang("categoryprogram::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("categoryprogram::text.action")
                            </th>
                        </tr>
                    </thead>
