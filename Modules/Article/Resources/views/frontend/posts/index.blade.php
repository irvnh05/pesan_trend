...
<section class="mt-5">
    <div class="hero  overflow-hidden" style="height: 20vh;">
        <div class="container">
            <div class="-mx-4 flex flex-wrap items-center">
              <div class="w-full px-4">
                <div class="text-center">
                    <h1 data-aos="fade-up" class="aos-init aos-animate">Artikel</h1>
                </div>
              </div>
            </div>
          </div>
...
<section class="section section-lg line-bottom-light">
    ...
    <div class="d-flex justify-content-center mt-3">
        {{ $$module_name->links('pagination::simple-bootstrap-4', ['prev', 'next']) }}
