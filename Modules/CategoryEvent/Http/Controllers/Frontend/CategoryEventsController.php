...
namespace Modules\CategoryEvent\Http\Controllers\Frontend;
...
class CategoryEventsController extends Controller
{
    public function __construct()
    {
        ...
        $this->module_path = 'categoryevents';
    ...
    public function index()
    {
        ...
        return view(
            "categoryevent::frontend.$module_path.index",
    ...
    public function show($id)
    {
        ...
        return view(
            "categoryevent::frontend.$module_name.show",
