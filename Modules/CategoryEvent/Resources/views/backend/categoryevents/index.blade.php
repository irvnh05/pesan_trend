                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("categoryevent::text.name")
                            </th>
                            <th>
                                @lang("categoryevent::text.slug")
                            </th>
                            <th>
                                @lang("categoryevent::text.updated_at")
                            </th>
                            <th>
                                @lang("categoryevent::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("categoryevent::text.action")
                            </th>
                        </tr>
                    </thead>
